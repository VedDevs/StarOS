...
A simple notes application used to display personal information and messages.

### 📖 Wikipedia

Provides access to Wikipedia from within StarOS.
...
```bash
git clone https://github.com/VedDevs/StarOS.git
```
